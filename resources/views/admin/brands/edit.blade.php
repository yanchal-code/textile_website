<section>
    ...
    <div class="container-fluid">
        ...
        <form id="categoryCreatForm" method="post" class="needs-validation custom-form" novalidate>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input value="{{ $category->slug }}" type="text" required readonly name="slug"
...
<script>
    $('#categoryCreatForm').submit(function(e) {
        ...
        if (form[0].checkValidity() === true) {
            ...
            $.ajax({
                type: "post",
                url: "{{ route('brands.edit', $category->id) }}",
                data: formData,
                headers: {
