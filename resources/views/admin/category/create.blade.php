    ...
    <form id="categoryCreatForm" method="post" class="needs-validation custom-form" novalidate enctype="multipart/form-data">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        <label for="slug" class="form-label">Slug <span class="text-danger">*</span> <small>(System
                                Generated)</small><span id="slugLoader" class="d-none"><span class="loader"></span>
                                Loading...</span>
                        </label>
                    ...
                    <div class="mb-3">
                        <div class="form-group">
                            ...
                            <input type="file" required
                                class="form-control img_input @error('adminImg') is-invalid @enderror"
