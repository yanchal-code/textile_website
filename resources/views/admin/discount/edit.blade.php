                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input autocomplete="off" value="{{ $code->code }}" required type="text"
                                    name="code" id="code" class="form-control" placeholder="coupon code">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="name">Coupon Name</label>
                                <input autocomplete="off" value="{{ $code->name }}" type="text" name="name"
                                    id="name" class="form-control" placeholder="coupon name">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="max_uses">Max Uses <small>(How many times the coupon can be
                                        used)</small></label>
                                <input value="{{ $code->max_uses }}" type="text" name="max_uses" id="max_uses"
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="max_uses_user">Max user uses <small>(how many times user can use a
                                        coupon)</small></label>
                                <input value="{{ $code->max_uses_user }}" type="number" name="max_uses_user"
                                    id="max_uses_user" class="form-control" placeholder="max user uses">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select required name="type" id="type" class="form-select">
                                    ...
                                    <option {{ $code->type == 'percent' ? 'selected' : '' }} value="percent">Percent
                                    </option>

                                    <option {{ $code->type == 'freeShipping' ? 'selected' : '' }} value="freeShipping">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="discount_amount">Discount amount <span id="discount_amount_label"
                                        class="text-danger">{{ $code->type == 'freeShipping' ? '' : '*' }}</span></label>
                                <input value="{{ $code->discount_amount }}"
                                    {{ $code->type == 'freeShipping' ? '' : 'required' }} type="number"
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input value="{{ $code->min_amount }}" type="number" name="min_amount" id="min_amount"
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select required type="text" name="status" id="status" class="form-select">
                                    ...
                                    <option {{ $code->status == 0 ? 'selected' : '' }} value="0">Inactive
                                    </option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input value="{{ $code->starts_at }}" autocomplete="off" type="datetime-local"
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input value="{{ $code->expires_at }}" autocomplete="off" type="datetime-local"
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="description" id="description" cols="30" rows="5">{{ $code->description }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    $('#categoryCreatForm').submit(function(e) {
        ...
        if (form[0].checkValidity() === true) {
            ...
            $.ajax({
                type: "post",
                url: "{{ route('discount.edit', $code->id) }}",
                data: formData,
                headers: {
