...
@section('content')
    ...
    <div class="container py-3">
        ...
        <form id="product-form" action="{{ route('products.edit.store', $product->id) }}" class="needs-validation" novalidate
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" value="{{ $product->s_services }}" class="form-control" id="s_services"
                            name="s_services">
                    </div>
                </div>
                ...
                <div id="shippingContainer" class="col-12 row" style="display: none;">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input value="{{ $product->inrShipping }}" type="text" class="form-control"
                                id="inrShipping" name="inrShipping">
                        </div>
                    </div>
                ...
                <div class="text-center mt-4" style="background-color: #fff1f1cc;">Specs Fields </div>
                ...
                <div class="col-12 row mt-2">
                    <div class="mb-3 col-md-6 variable1stMain">
                        ...
                        <input type="text" value="{{ $product->color }}" class="form-control" id="color"
                            name="color">
                    </div>

                    <div class="mb-3 col-md-6 variable2ndMain">
                        <label for="size" value="{{ $product->size }}" class="form-label"><span
                                class="variable2nd"></span>
                        </label>
                ...
                <script>
                    $(document).ready(function() {
                        ...
                        var variable1st = '{{ $product->leafCategory->v1st }}';
                        var variable2nd = '{{ $product->leafCategory->v2nd ?? 'Not Set' }}';
                        ...
                        $("#leaf_category").change(function() {
                            ...
                            if (leafCategoryId) {
                                ...
                                $("#specsContainer").html(""); // Clear specs if no leaf category selected
            ...
            <a class="btn btn-secondary my-3">Cancel</a>
