            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header border-0">
                        <h5 class="modal-title" id="downloadModalLabel">Download Example Excel</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form method="post" action="{{ route('product.example.export') }}">
                            @csrf
                            <div class="mb-3">
                                ...
                                <select name="export_leaf_category" id="leaf_category" class="form-select">
                                    ...
                                    @foreach ($leafCategories as $leafCategory)
                                        <option value="{{ $leafCategory->id }}">{{$leafCategory->subCategory->name}} / {{ $leafCategory->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <td>
                                @if ($product->has_variations)
                                    <a class="btn btn-sm btn-success m-1"
                                        href="{{ route('products.variations', $product->id) }}">Variations</a> <br>
                                @endif
