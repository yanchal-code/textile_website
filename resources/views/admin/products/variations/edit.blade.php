...
@section('content')
    ...
    <div class="container py-3">
        ...
        <form id="product-form" action="{{ route('variations.edit.store', $variation->id) }}" class="needs-validation custom-form"
            ...
            <div class="row">
                ...
                <div class="mb-3 col-md-6">
                    ...
                    <input type="text" value="{{ $variation->color }}" class="form-control" id="color"
                        name="color" required>
                </div>
                @if ($secondVarField)
                    <div class="mb-3 col-md-6">
                        <label for="size" class="form-label">{{ $product->leafCategory->v2nd }} <span
                                class="text-danger">*</span></label>
                        <input type="text" value="{{ $variation->size }}" class="form-control" id="size"
                            name="size" required>
                    </div>
                @endif
                ...
                <div class="mb-3 col-md-6">
                    ...
                    <input type="text" value="{{ $variation->price }}" class="form-control" min="0.00"
