    ...
    <div class="container-fluid">
        <form id="categoryCreatForm" class="needs-validation custom-form" novalidate method="post">
            ...
            <div class="row">
                        ...
                        <select required name="category_id" id="category_id" class="form-select">
                            ...
                            @if ($categories->isNotEmpty())
                                @foreach ($categories as $data)
                                    <option @if ($sub_category->category_id == $data->id) selected @endif
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" value="{{ $sub_category->name }}" name="name" required id="name"
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input value="{{ $sub_category->slug }}" type="text" required name="slug" id="slug"
                ...
                <div class="col-md-6">
                    ...
                    <img src="{{ asset($sub_category->image) }}" alt="img" class="img-fluid" style="max-height:100px;">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <select type="text" name="status" id="status" class="form-select">
                            <option @if ($sub_category->status == 1) selected @endif value="1">Active
                            </option>
                            <option @if ($sub_category->status == 0) selected @endif value="0">Inactive
                            </option>
                        </select>
                    </div>
                </div>
            ...
            <div class="pb-5 pt-3 text-center">
                ...
                <a href="{{ route('subCategories.view') }}" class="btn btn-outline-dark ml-3">Cancel</a>
            </div>
        </form>
    </div>
    <!-- /.card -->
...
<script>
    $('#categoryCreatForm').submit(function(e) {
        ...
        if (form[0].checkValidity() === true) {
            ...
            $.ajax({
                type: "post",
                url: "{{ route('subCategories.edit', $sub_category->id) }}",
                data: formData,
                headers: {
