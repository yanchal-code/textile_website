                    ...
                    <div class="col-lg-6">
                        <div class="about__thumb d-flex">
                            <div class="about__thumb--items">
                                <img class="about__thumb--img border-radius-5 display-block" src="{{asset('frontend/img/other/about-thumb-list1.png')}}" alt="about-thumb">
                            </div>
                            <div class="about__thumb--items position__relative">
                                <img class="about__thumb--img border-radius-5 display-block" src="{{asset('frontend/img/other/about-thumb-list2.png')}}" alt="about-thumb">
                    ...
                    <div class="col-lg-6">
                        <div class="about__content">
                            ...
                            <div class="about__author position__relative d-flex align-items-center">
                                ...
                                <img class="about__author--signature display-block" src="{{asset('frontend/img/icon/signature.png')}}" alt="signature">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="team__container">
                    <div class="row">
                        <div class="col-lg-3 col-md-4 col-sm-6 col-6 custom-col">
                            <div class="team__items text-center">
                                <div class="team__thumb">
                                    <img class="team__thumb--img border-radius-50" src="{{asset('frontend/img/other/team1.png')}}" alt="">
                                </div>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-6 custom-col">
                            <div class="team__items text-center">
                                <div class="team__thumb">
                                    <img class="team__thumb--img border-radius-50" src="{{asset('frontend/img/other/team2.png')}}" alt="">
                                </div>
                                <div class="team__content">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-6 custom-col">
                            <div class="team__items text-center">
                                <div class="team__thumb">
                                    <img class="team__thumb--img border-radius-50" src="{{asset('frontend/img/other/team3.png')}}" alt="">
                                </div>
                                <div class="team__content">
                ...
                <div class="testimonial__section--inner testimonial__swiper--activation swiper">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="testimonial__items text-center">
                                <div class="testimonial__items--thumbnail">
                                    <img class="testimonial__items--thumbnail__img border-radius-50" src="{{asset('frontend/img/other/testimonial-thumb1.png')}}" alt="testimonial-img">
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial__items text-center">
                                <div class="testimonial__items--thumbnail">
                                    <img class="testimonial__items--thumbnail__img border-radius-50" src="{{asset('frontend/img/other/testimonial-thumb2.png')}}" alt="testimonial-img">
                                </div>
                                <div class="testimonial__items--content">
                                    <h3 class="testimonial__items--title">Nike Mardson</h3>
                                    <span class="testimonial__items--subtitle">fashion</span>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial__items text-center">
                                <div class="testimonial__items--thumbnail">
                                    <img class="testimonial__items--thumbnail__img border-radius-50" src="{{asset('frontend/img/other/testimonial-thumb3.png')}}" alt="testimonial-img">
                                </div>
                                <div class="testimonial__items--content">
                                    <h3 class="testimonial__items--title">Nike Mardson</h3>
                                    <span class="testimonial__items--subtitle">fashion</span>
