                ...
                <div class="main__header--inner position__relative d-flex justify-content-between align-items-center">
                               ...
                               <li class="header__menu--items">
                                ...
                                <li class="header__menu--items">
                                    ...
                                    <ul class="header__sub--menu">
                                        <li class="header__sub--menu__items"><a href="{{route('account.register')}}" class="header__sub--menu__link">Register</a></li>
                                        ...
                                        <li class="header__sub--menu__items"><a href="{{route('account.login')}}" class="header__sub--menu__link">Login Page</a></li>
                    ...
                    <div class="header__account header__account2">
                        <ul class="d-flex">
                           ...
                           <li class="header__account--items header__account2--items">
                            <a class="header__account--btn" href="{{ route('front.cart') }}">
                                ...
                                <!-- ✅ Dynamic Cart Count -->
                                <span class="items__count style2 totalItemsInCart">
            ...
            <div class="minicart__product">
                <div class="minicart__product--items d-flex">
                    <div class="minicart__thumb">
                        <a href="product-details.html"><img src="{{ asset('frontend/img/product/product1.png') }}" alt="prduct-img"></a>
                    </div>
