                            ...
                            <form action="" method="POST">
                                ...
                                <div class="product__details--info__price mb-10">
                                    ...
                                    @if($product->price)
                                        ...
                                        <span class="old__price">${{ $product->compare_price }}</span>
                                    @endif
                                </div>
                                            ...
                                            <li class="rating__list">
                                                <span class="rating__list--icon">
                                                    <svg class="rating__list--icon__svg" xmlns="http://www.w3.org/2000/svg" width="14.105" height="14.732" viewBox="0 0 10.105 9.732">
                                                        <path d="M9.837,3.5,6.73,3.039,5.338.179a.335.335,0,0,0-.571,0L3.375,3.039.268,3.5a.3.3,0,0,0-.178.514L2.347,6.242,1.813,9.4a.314.314,0,0,0,.464.316L5.052,8.232,7.827,9.712A.314.314,0,0,0,8.292,9.4L7.758,6.242l2.257-2.231A.3.3,0,0,0,9.837,3.5Z" transform="translate(0 -0.018)" fill="{{ $i <= $product->rating ? 'currentColor' : '#ccc' }}"></path>
                                                    </svg>
                                                </span>
                                            </li>
                                        @endfor
                                    </ul>
                                    <span class="product__items--rating__count--number">({{ $product->reviews_count }})</span>
                                </div>
                                ...
                                <div class="product__variant">
                                    ...
                                    @if($product->specs)
                                        ...
                                        @endphp
                                        <div class="product__variant--list mb-15 row gx-3 gy-3">
                                            @foreach($specs as $key => $value)
                                                @if(strpos($value, ',') !== false)
                                                    @php $options = explode(',', $value); @endphp
                                                    <div class="col-md-6">
                                                        <label for="{{ $key }}" class="form-label fw-semibold text-capitalize">{{ str_replace('_',' ',$key) }}</label>
                    ...
                    <script>
                        document.querySelectorAll('.increase').forEach(btn => {
                            btn.addEventListener('click', () => {
                                let input = btn.previousElementSibling.querySelector('input');
                                input.value = parseInt(input.value) + 1;
                            });
                        });
                        document.querySelectorAll('.decrease').forEach(btn => {
                            btn.addEventListener('click', () => {
                                let input = btn.nextElementSibling.querySelector('input');
