                ...
                <div class="row row-cols-1">
                    <div class="col">
                        <div class="breadcrumb__content text-center">
                            <h1 class="breadcrumb__content--title text-white mb-25">Product Gallery</h1>
                            <ul class="breadcrumb__content--menu d-flex justify-content-center">
                                <li class="breadcrumb__content--menu__items"><a class="text-white" href="index.html">Home</a></li>
                                <li class="breadcrumb__content--menu__items"><span class="text-white">Product Gallery</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col">
                        <div class="product__details--gallery">
                            <div class="row row-cols-2 mb--n28">
                                <div class="col mb-28">
                                    <img class="display-block" src="{{asset('frontend/img/product/product1.png')}}" alt="product gallery img">
                                </div>
                                <div class="col mb-28">
                                    <img class="display-block" src="{{asset('frontend/img/product/product2.png')}}" alt="product gallery img">
                                </div>
                                <div class="col mb-28">
                                    <img class="display-block" src="{{asset('frontend/img/product/product3.png')}}" alt="product gallery img">
                                </div>
                                <div class="col mb-28">
                                    <img class="display-block" src="{{asset('frontend/img/product/product4.png')}}" alt="product gallery img">
                                </div>
                            </div>
                        </div>
                    </div>   
                                    ...
                                    <div class="product__reviews">
                                        ...
                                        <div class="reviews__comment--area">
                                            ...
                                            <div class="reviews__comment--list margin__left d-flex">
                                                <div class="reviews__comment--thumb">
                                                    <img src="{{asset('frontend/other/comment-thumb2.png')}}" alt="comment-thumb">
                                                </div>
                                                <div class="reviews__comment--content">
                                                    <div class="reviews__comment--top d-flex justify-content-between">
                                                        <div class="reviews__comment--top__left">
